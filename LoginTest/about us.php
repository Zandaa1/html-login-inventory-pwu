...
<div class="container">
    ...
    <div class="container">
        <div class="mt-4 p-5 bg-gradient text-white">
            <div class="row">
                <div class="col-sm-6">
                    <img src="img/Kevin (1).png" style="width:100%;box-shadow: 5px 7px;margin-left:2%;">
                </div>
                <div class="col-sm-6">
                    <h1>Alexander Mangahas</h1>
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <small>Small Text</small>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem, laboriosam, voluptas cupiditate
                            assumenda enim, corporis eius laborum reiciendis ex in doloribus aperiam eaque fugit minus
                            ea!
                            Sunt vitae asperiores sed?</p>
                        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quo, adipisci, eius consequatur
                            soluta
                            nostrum qui error aperiam eos ab atque exercitationem amet nulla id expedita, incidunt vel!
                            Et,
                            quis nostrum!</p>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum, maxime obcaecati ipsa sint
                            dolorum dolore autem, corrupti esse laudantium aut culpa, voluptas cum? Nisi tempora sint
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h1>Kevin R. De Jesus</h1>
                            <small>Small Text</small>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem, laboriosam, voluptas
                                cupiditate
                                assumenda enim, corporis eius laborum reiciendis ex in doloribus aperiam eaque fugit
                                minus ea!
                                Sunt vitae asperiores sed?</p>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quo, adipisci, eius consequatur
                                soluta
                                nostrum qui error aperiam eos ab atque exercitationem amet nulla id expedita, incidunt
                                vel! Et,
                                quis nostrum!</p>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum, maxime obcaecati ipsa
                                sint
                                dolorum dolore autem, corrupti esse laudantium aut culpa, voluptas cum? Nisi tempora
                                sint
                                facilis eligendi debitis asperiores.</p>
                        </div>
                        <div class="col-sm-6">
